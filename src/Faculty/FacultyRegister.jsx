    ...
    <div className="min-h-screen bg-slate-50 text-slate-700 font-sans flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md mb-8">
        <div className="flex justify-center mb-6">
          <div className="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-600/10 transform -rotate-6">
            <GraduationCap size={32} className="text-white" />
          </div>
        </div>
        <h2 className="text-center text-4xl font-black tracking-tighter text-blue-900 italic uppercase">
          Faculty <span className="text-teal-600">Recruitment</span>
        </h2>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-2xl">
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200 py-10 px-6 shadow-2xl rounded-[2.5rem] sm:px-12 relative">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-1 bg-teal-600 rounded-b-full"></div>
  ...
  <div>
    ...
    <div className="relative group">
      ...
      <input
        ...
        className="block w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-[1.25rem] text-slate-900 text-sm placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-mono"
      />
    </div>
  </div>
);
  ...
  <div>
    ...
    <div className="relative group">
      ...
      <select
        ...
        onChange={onChange}
        required={required}
        className="block w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-[1.25rem] text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all appearance-none cursor-pointer"
      >
