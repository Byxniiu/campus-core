    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md mb-8">
        <div className="flex justify-center mb-6">
          <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-indigo-600/20 transform -rotate-6">
            <GraduationCap size={32} className="text-white" />
          </div>
        </div>
        <h2 className="text-center text-4xl font-black tracking-tighter text-white italic uppercase">
          Faculty <span className="text-indigo-400">Recruitment</span>
        </h2>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-2xl">
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 py-10 px-6 shadow-2xl rounded-[2.5rem] sm:px-12 relative">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-1 bg-indigo-600 rounded-b-full"></div>
  ...
  <div>
    ...
    <div className="relative group">
      ...
      <select
        ...
        onChange={onChange}
        required={required}
        className="block w-full pl-12 pr-4 py-4 bg-slate-800/50 border border-slate-700/50 rounded-[1.25rem] text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all appearance-none cursor-pointer"
      >
